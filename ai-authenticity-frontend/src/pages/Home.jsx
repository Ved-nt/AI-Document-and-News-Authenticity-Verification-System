    ...
    <PageWrapper>
      <section className="flex flex-col items-center justify-center px-6 py-32 text-center">
        ...
        <p ref={desc} className="mt-6 max-w-2xl text-slate-300">
          An AI-powered system that analyzes textual patterns and
          graph-based relationships to verify authenticity.
        </p>

        <div ref={buttons} className="mt-10 flex flex-wrap gap-4">
          <Link to="/verify" className="px-6 py-3 rounded-lg bg-sky-500 text-slate-900 font-semibold hover:bg-sky-400 transition">
            Verify News / Text
          </Link>

          <Link to="/document" className="px-6 py-3 rounded-lg border border-sky-400 text-sky-400 hover:bg-sky-400 hover:text-slate-900 transition">
            Document Forgery Check
          </Link>

          <Link to="/about" className="px-6 py-3 text-slate-300 hover:text-sky-400 transition">
            About Project
          </Link>
        </div>
      </section>
