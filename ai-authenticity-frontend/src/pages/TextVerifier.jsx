  ...
  return (
    <PageWrapper>
      <div className="max-w-3xl mx-auto px-6 py-24">
        <h2 className="text-3xl font-semibold mb-6">Verify News / Text</h2>
        ...
        <p className="text-sm text-slate-500 mt-2">Characters: {text.length}</p>

        <button
          disabled={!text || loading}
          onClick={verify}
          className="mt-4 px-6 py-3 bg-sky-500 rounded-xl text-black font-semibold disabled:opacity-50 flex items-center gap-2"
        >
